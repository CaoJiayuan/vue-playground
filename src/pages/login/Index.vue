  ...
  <v-layout>
    <v-flex xs12 md4 offset-md4 style="margin-top: 50px">
      <v-card>
        ...
        <v-progress-linear :indeterminate="true" height="3" color="green" style="margin: 0"
                           v-if="requesting"></v-progress-linear>
        <v-card-text>
        ...
        <v-card-actions>
          <v-btn color="primary" @click="login" :disabled="!this.valid">登陆</v-btn>
        </v-card-actions>
      </v-card>
    </v-flex>
  </v-layout>
